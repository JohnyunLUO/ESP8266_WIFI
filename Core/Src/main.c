...
int main(void)
{
  ...
  QueueInit(&pcTxQueue, pcTxBuff, sizeof(pcTxBuff));
  QueueInit(&pcRxQueue, pcRxBuff, sizeof(pcRxBuff));
  QueueInit(&wifiTxQueue, wifiTxBuff, sizeof(wifiTxBuff));
  QueueInit(&wifiRxQueue, wifiRxBuff, sizeof(wifiRxBuff));
